...
| FR-011 | Implement multi-library self-hosted storage, per-user authorization, scanning/change detection, metadata/artwork, favorites, ratings, recent activity, and persistent queues. | High | In progress — the SQLite application-state and per-user library-authorization foundation, including schema-v1 owner-membership preservation, is merged and post-merge validated on `main` at `564ac6a792070996dc39b103232c39b4fca95074`; scanning/change detection, metadata/artwork, ingestion, recent activity, library/search APIs, recovery acceptance, and remaining Milestone 1 work remain pending. |
...
| FR-075 | Adopt the documented Milestone 0–8 implementation sequence and require verified source/test evidence before any milestone, feature, or client target is treated as complete. | High | In progress — Milestone 0 is merged; the bounded Milestone 1 SQLite persistence/authorization foundation is merged and post-merge validated on `main` at `564ac6a792070996dc39b103232c39b4fca95074`; the remainder of Milestone 1 and Milestones 2–8 remain pending. |
