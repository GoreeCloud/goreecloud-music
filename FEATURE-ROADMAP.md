...
| FR-011 | Implement self-hosted multi-library music storage, authorization, incremental scanning, filesystem change detection, embedded/sidecar metadata, artwork, favorites, ratings, recently added/played, and persistent queues. | High | In progress — PR #7 merged and post-merge validated the SQLite application-state and per-user library-authorization foundation. PR #9 merged schema-v3 `library_files`, supported-audio discovery, source-preserving Added/Updated/Unchanged/Missing/Restored reconciliation, missing-file tombstones, no-symlink scanning, and permission-gated file-state access as `ac42ebc6f5fe3143c0cbc77cd6c3fce7397f44ac`; post-merge Music CI `35020139101` and Platform Contract `35020140030` passed. PR #12 merged authorization-scoped Favorites, Ratings, and Recently Played persistence as `168d19d07e9b32e0089a512b9e6b7964db76ece1`; post-merge Music CI `35026228206` and Platform Contract `35026228918` passed. PR #14 merged authorization-scoped Recently Added as `c20acc1a92ee71ee4173468d97a5980ccf396013`; post-merge Music CI `35028245616` and Platform Contract `35028246120` passed. PR #16 then merged schema-v4 `library_file_metadata` plus bounded read-only MP3 ID3v2.3/v2.4 and FLAC Vorbis Comment extraction as signed `main` `bc90686a18338afef650b73357f454d1be541afb`; exact candidate `fc9613d94493e2d5c355f3aba7b6bd2a24a2d334` passed Music CI `35030658032` and Platform Contract `35030658657`, and post-merge `main` passed Music CI `35030857299` and Platform Contract `35030858110`. Approved sidecars, artwork, additional metadata formats, canonical media ingestion, codec/container probing, event-driven change detection, library/search/metadata APIs, persistent queues, production recovery acceptance, and remaining Milestone 1 work remain pending. |
...
| FR-016 | Implement optional online music discovery including recommendations, trending music, Quick Picks, new releases, charts, genres, moods, decades, related music, radios, and mixes with explicit source identity. | Medium | Planned; YouTube portion proposed |
...
| FR-075 | Adopt the documented Milestone 0–8 implementation sequence and require verified source/test evidence before any milestone, feature, or client target is treated as complete. | High | In progress — Milestone 0 is merged. Milestone 1 has verified merged persistence/authorization, source-preserving scanner/reconciliation, profile-state, Recently Added, and bounded embedded metadata foundations. PR #16 is authoritative on signed `main` at `bc90686a18338afef650b73357f454d1be541afb`; exact candidate `fc9613d94493e2d5c355f3aba7b6bd2a24a2d334` passed Music CI `35030658032` and Platform Contract `35030658657`, and post-merge `main` passed Music CI `35030857299` and Platform Contract `35030858110`. The remainder of Milestone 1 and Milestones 2–8 remain pending. |
