...
PR #9's exact candidate `a6579a7e029881ef80d8d202833de19deceb2da4` passed Music CI `35019904248` and Platform Contract `35019905704`. The merged `main` revision passed post-merge Music CI `35020139101` and Platform Contract `35020140030`.
...
- multi-user isolation tests across every remaining library query/mutation path;
